...
export const DASHBOARD_NAV_ITEMS: DashboardNavItem[] = [
  // Sidebar: dsa, system, jobs, calendar first (user preference)
  {
    id: "dsa",
    href: "/dsa",
    label: "DSA Tracker",
    ...
    icon: Hand,
    domain: "dsa",
    priority: 3, // Lower priority so launchpad prefers coach/plan
    showInSidebar: true,
  ...
  // Launchpad: coach, plan have highest priority (lowest number)
  {
    id: "coach",
    href: "/coach",
